...
# Try to loop this process to have all FPCMs of all experts
...
ggsave("figs/f_w_soc.png", f_soc_plt , width = 12, height = 4)
ggsave("figs/f_w_phy.png", f_phy_plt, width = 12, height = 4)

# Arrange the two plots vertically
f_w <- grid.arrange(f_soc_plt, f_phy_plt, ncol = 2)

ggsave("figs/f_w.png", f_w, width = 10, height = 5)
```
